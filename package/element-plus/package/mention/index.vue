        ...
        <slot v-else v-bind="slotProps">
            ...
            >
                <template v-if="slotLabel || $slots.label" #label="{ item, index }">
                    <slot v-if="$slots.prefix" name="prefix" :item="item" :index="index" />
                    <component
                ...
                <template v-if="slotHeader || $slots.header" #header>
                    <slot v-if="$slots.prefix" name="prefix" />
                    <component :is="getNode(slotHeader!, { backfill, query, search, insideSearch })" v-else />
                </template>
                <template v-if="slotFooter || $slots.footer" #footer>
                    <slot v-if="$slots.prefix" name="prefix" />
                    <component :is="getNode(slotFooter!, { backfill, query, search, insideSearch })" v-else />
                </template>
